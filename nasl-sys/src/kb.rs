...
pub type kb_item_type = ::std::os::raw::c_uint;
...
pub type kb_nvt_pos = ::std::os::raw::c_uint;
...
pub union kb_item__bindgen_ty_1 {
    pub v_str: *mut ::std::os::raw::c_char,
    pub v_int: ::std::os::raw::c_int,
...
pub struct kb_operations {
    ...
    >,
    pub kb_delete: ::std::option::Option<unsafe extern "C" fn(arg1: kb_t) -> ::std::os::raw::c_int>,
    ...
    pub kb_get_nvt_all: ::std::option::Option<
        unsafe extern "C" fn(arg1: kb_t, arg2: *const ::std::os::raw::c_char) -> *mut nvti_t,
    >,
    /// < Get list of OIDs.
    ...
    pub kb_get_all: ::std::option::Option<
        unsafe extern "C" fn(arg1: kb_t, arg2: *const ::std::os::raw::c_char) -> *mut kb_item,
    >,
    pub kb_get_pattern: ::std::option::Option<
        unsafe extern "C" fn(arg1: kb_t, arg2: *const ::std::os::raw::c_char) -> *mut kb_item,
    >,
    pub kb_count: ::std::option::Option<
        unsafe extern "C" fn(arg1: kb_t, arg2: *const ::std::os::raw::c_char) -> usize,
    >,
    ...
    >,
    pub kb_save: ::std::option::Option<unsafe extern "C" fn(arg1: kb_t) -> ::std::os::raw::c_int>,
    pub kb_lnk_reset:
        ::std::option::Option<unsafe extern "C" fn(arg1: kb_t) -> ::std::os::raw::c_int>,
